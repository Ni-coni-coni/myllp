class Game {
    ...
    constructor() {
        ...
        // k=0->timing, k=1->position, k=2->type, k=3->isMulti, k=4->existence, k=5->onhold,
    ...
    init() {
        ...
        .then(() => {
            ...
            this.initBackGround(this.loader.getAsset("bg"), this.loader.getAsset("skin"));
            ...
            this.initBeatmap(this.loader.getAsset("beatmap"));

            this.setCoordinates(this.startX, this.startY, this.destR);
            // this.setCoordinatesMaiMai(this.startX, this.startY, this.destR);
    ...
    */
    ...
    addTouchEndEventListener() {
        this.refs.gameCanvas.addEventListener("touchend", (e) => {
            ...
            // this.refs.debugDiv.innerText = "canvasX:" + canvasX + "\ncanvasY:" + canvasY;
            let judgement;
            let lanesTouchEnd = this.judge.getJudgeLanes(this.judgeAreaCenters, this.judgeAreaRadii,
                canvasTouchCoords);
            let lanesOnTouch = this.judge.getJudgeLanes(this.judgeAreaCenters, this.judgeAreaRadii,
                canvasOnTouchCoords);
